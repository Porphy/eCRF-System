...
module Export
  ...
  EXPORT_TABLE_NAMES  = %w( patient group_information basement_assessment death_record adverse_events radiation_therapies concomitant_drugs biological_sample_collections)
